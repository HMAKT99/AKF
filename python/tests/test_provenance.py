...
class TestIntegrityHash:
    ...
    def test_detects_tampering(self):
        ...
        tampered = unit.model_copy(update={"claims": [Claim(content="tampered", confidence=0.1)]})
    ...
    def test_excludes_hash_field(self):
        unit = create("test", confidence=0.5)
        h1 = compute_integrity_hash(unit)
        unit_with_hash = unit.model_copy(update={"integrity_hash": "sha256:old"})
...
class TestValidateChain:
    def test_valid_chain(self):
        prov = [
            ...
            ProvHop(hop=1, actor="b", action="enriched", timestamp="2025-01-01T01:00:00Z"),
        ]
    ...
    def test_invalid_chain(self):
        prov = [
            ProvHop(hop=0, actor="a", action="created", timestamp="2025-01-01T00:00:00Z"),
            ProvHop(hop=5, actor="b", action="enriched", timestamp="2025-01-01T01:00:00Z"),
        ]
...
class TestAddHop:
    def test_add_first_hop(self):
        ...
        assert updated.integrity_hash is not None
